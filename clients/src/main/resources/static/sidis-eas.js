...
MOCK = {
    ...
    "/api/v1/me" : {"me":{"commonName":null,"organisationUnit":null,"organisation":"Swisscanto Pensions Ltd.","locality":"Zurich","state":"ZH","country":"CH","x500Principal":{"name":"O=Swisscanto Pensions Ltd.,L=Zurich,ST=ZH,C=CH","encoded":"ME4xCzAJBgNVBAYTAkNIMQswCQYDVQQIDAJaSDEPMA0GA1UEBwwGWnVyaWNoMSEwHwYDVQQKDBhTd2lzc2NhbnRvIFBlbnNpb25zIEx0ZC4="}}},
    "/api/v1/peers" : {"peers":[{"commonName":null,"organisationUnit":null,"organisation":"Swiss Life Ltd.","locality":"Zurich","state":"ZH","country":"CH","x500Principal":{"name":"O=Swiss Life Ltd.,L=Zurich,ST=ZH,C=CH","encoded":"MEUxCzAJBgNVBAYTAkNIMQswCQYDVQQIDAJaSDEPMA0GA1UEBwwGWnVyaWNoMRgwFgYDVQQKDA9Td2lzcyBMaWZlIEx0ZC4="}},{"commonName":null,"organisationUnit":null,"organisation":"AXA Leben AG","locality":"Winterthur","state":"ZH","country":"CH","x500Principal":{"name":"O=AXA Leben AG,L=Winterthur,ST=ZH,C=CH","encoded":"MEYxCzAJBgNVBAYTAkNIMQswCQYDVQQIDAJaSDETMBEGA1UEBwwKV2ludGVydGh1cjEVMBMGA1UECgwMQVhBIExlYmVuIEFH"}},{"commonName":null,"organisationUnit":null,"organisation":"FZL","locality":"Zug","state":"ZG","country":"CH","x500Principal":{"name":"O=FZL,L=Zug,ST=ZG,C=CH","encoded":"MDYxCzAJBgNVBAYTAkNIMQswCQYDVQQIDAJaRzEMMAoGA1UEBwwDWnVnMQwwCgYDVQQKDANGWkw="}}]}
}
